...
This is the overview of the granularities for [Ground-based](/it/a-data-groundbased) as well as for [Climate stations - Homogeneous data series](/it/c-climate-data/c1-climate-stations_homogeneous) and [Climate precipitation stations - Homogeneous data series](/it/c-climate-data/c2-climate-percipitation-stations_homogeneous) used by MeteoSwiss:
...
### Update frequency
For [Ground-based](/it/a-data-groundbased) and [Atmosphere measurements](/it/b-data-atmosphere) as well as for [Climate stations – Homogeneous data series](/it/c-climate-data/c1-climate-stations_homogeneous) and [Climate precipitation stations - Homogeneous data series](/it/c-climate-data/c2-climate-percipitation-stations_homogeneous) MeteoSwiss provides an optimized directory structure separating older historical data, which is not updated regularly, and more recent data, which is updated more often. For realtime data we provide a third "now" directory with a high update frequency.
