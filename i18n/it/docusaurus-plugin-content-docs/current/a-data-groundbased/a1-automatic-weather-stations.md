...
<Tabs queryString="Struttura dei dati">
  <TabItem value="file-per-stazione" label="File per stazione">
  ...
  <TabItem value="un-file-con-tutte-le-stazioni" label="Un file con tutte le stazioni">
