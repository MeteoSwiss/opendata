...
MeteoSchweiz nutzt zur Veröffentlichung die [Bundes Geodaten-Infrastruktur BGDI](https://www.geo.admin.ch/de/impressum-verantwortlichkeiten-und-kontakte), die vom Bundesamt für Landestopografie swisstopo betrieben wird, sowie den Public Cloud Objektspeicher-Service des [Swiss National Supercomputing Centre (CSCS)](https://www.cscs.ch/information/imprint-disclaimer), betrieben durch die ETH Zürich. Siehe dazu Kapitel [4 Nutzung der Infrastruktur](#4-nutzung-der-infrastruktur).  
