...
## Available Data
| [Ground-based Measurements](https://github.com/MeteoSwiss/opendata/tree/main?tab=readme-ov-file#ground-based-measurements) | Atmosphere Measurements | Observations | Climate Data | Radar Data | Forecast Data |
|-----|-----|-----|-----|-----|-----|
