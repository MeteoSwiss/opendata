...
| C5 | [Radar-based spatial climate data - *Probability of Hail, Maximum Expected Severe Hail Size*](https://github.com/MeteoSwiss/opendata-climate-data/blob/main/README.md#c5---radar-based-spatial-climate-data) | :white_circle: | :white_circle: |
