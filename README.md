...
Starting in April 2025, MeteoSwiss is gradually making its data freely accessible to the public as Open Government Data (OGD). The pre-processed data can be [downloaded as files](#getting-started-with-download).
