...
| C5 | [Radar-based spatial climate data - Number of Hail Days, Hailstone Sizes](https://github.com/MeteoSwiss/opendata-climate-data/blob/main/README.md#c5---radar-based-spatial-climate-data) | :white_circle: | :white_circle: |
