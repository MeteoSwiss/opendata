...
| C8 | [Climate scenarios](https://github.com/MeteoSwiss/opendata-climate-data/blob/main/README.md#8-climate-scenarios) <br> *- CH2025 data expected to be available in November 2025* | `ogd-climate-scenarios` | 1️⃣ | 🟢 [CH2018 (referenced)](https://www.nccs.admin.ch/nccs/en/home/climate-change-and-impacts/swiss-climate-change-scenarios/ch2018-web-atlas.html) | ⚪ |
| C9 | [Spatial climate scenarios](https://github.com/MeteoSwiss/opendata-climate-data/blob/main/README.md#8-climate-scenarios) <br> *- CH2025 data expected to be available in November 2025* | `ogd-climate-scenarios-grid` | 1️⃣ | 🟢 [CH2018 (referenced)](https://www.nccs.admin.ch/nccs/en/home/climate-change-and-impacts/swiss-climate-change-scenarios/ch2018-web-atlas.html) | ⚪ |
