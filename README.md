...
| C5 | [Radar-based spatial climate data - Hailstone Sizes, Number of Hail Days](https://github.com/MeteoSwiss/opendata-climate-data/blob/main/README.md#c5---radar-based-spatial-climate-data) | :white_circle: | :white_circle: |
