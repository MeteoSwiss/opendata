...
Please note, that the daily files are preliminary results. They are available for the last 41 days only in the respective items (e.g. `CH at 31.12.2025`, `CH at 01.01.2026` etc.) and will be deleted continuously.

**If you need controled and corrected gridded data, you should only use data from the monthly or archive items.** 

The controled and corrected datasets containing the data of the last month will be published at the end of the following month. The datasets will be published on the 10th and 26th of the following month, whereas the datasets from the 10th will be overwritten by the one from the 26th. Differences between the two versions are possible. These files are in the respective monthly items (e.g. `CH at 12.2025`, `CH at 01.2026` etc.) and are only available for the last 14 months and will be deleted continously. 
