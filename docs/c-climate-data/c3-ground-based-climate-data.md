...
These grid data products are statistically derived from ground-based measurements.

**Precipitation** (see the linked detailed product documentations)
...
**Temperature** (see the linked detailed product documentations)
...
**Sunshine** (see the linked detailed product documentations)
