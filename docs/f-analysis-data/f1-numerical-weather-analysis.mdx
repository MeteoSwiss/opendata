...
The **first guess** is a one hour forecast produced by an ensemble of ICON model runs at 1km resolution before assimilating the next set of observations. It describes the atmospheric evolution during the previous hour and can therefore consistently provide these **time-aggregated variables**.
