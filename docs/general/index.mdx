...
We are currently setting up our service as Public Beta.
...
⚠️ We welcome your feedback. We collect all of it and answer it collectively to all users via our [Open Data repository on GitHub](https://github.com/MeteoSwiss/opendata/discussions/categories/public-beta-april-2025), rather than individually.
