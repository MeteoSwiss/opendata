...
MeteoSwiss is also working to enable access to certain data through individual API queries. However, this option will not be available before end of 2026.
