...
:handshake: We welcome [your feedback](general/contact). During Beta we answer it collectively to all users via our [Open Data repository (GitHub)](https://github.com/MeteoSwiss/opendata/discussions/categories/public-beta-april-2025), rather than individually.
