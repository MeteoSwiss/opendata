...
This is the overview of the granularities for [Ground-based](/a-data-groundbased) as well as for [Climate stations - Homogeneous data series](/c-climate-data/c1-climate-stations_homogeneous) and [Climate precipitation stations - Homogeneous data series](/c-climate-data/c2-climate-percipitation-stations_homogeneous) used by MeteoSwiss:
