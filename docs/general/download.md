...
- [1 - manually](#1---manually-download-files) *[upcoming]*
- [2 - programmatically](#2---programmatically-download-files)
...
- [3.1 - Column Separators and Decimal Dividers](#not-available)
- [3.2 - Data Granularity](#not-available)
- [3.3 - Update Frequency](#not-available)
...
- [4.1 - Time Stamps and Time Intervals](#not-available)
- [4.2 - Missing Values](#not-available)
