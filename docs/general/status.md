...
| [geocat.ch](https://www.geocat.ch/datahub/organization/Federal%20Office%20of%20Meteorology%20and%20Climatology%20MeteoSwiss) Geodata metadata catalog | swisstopo | [GeoAdmin API Uptime Status](https://api3.geo.admin.ch/api/status.html) | swisstopo [geocat.ch support](https://info.geocat.ch/en/contact) |
