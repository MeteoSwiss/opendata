...
| Numerical weather forecasting model processing | [CSCS - Swiss National Supercomputing Centre](https://www.cscs.ch/services/contractual-partners) | [CSCS Status Page Central Services](https://status.cscs.ch/) <br></br> **Resolved**: NWP Open Data publication was temporarily interrupted due to a technical compatibility issue in the data publication workflow. The first available runs after recovery are KENDA-CH1 `2026-09-17 13:00 UTC`, ICON-CH1-EPS `2026-09-17 15:00 UTC`, and ICON-CH2-EPS `2026-09-17 18:00 UTC`. Earlier affected runs were not backfilled and may remain missing within the 24-hour availability window. | MeteoSwiss [Open Data support](https://www.meteoswiss.admin.ch/about-us/contact/contact-form.html) |
