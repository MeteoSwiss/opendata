...
|:-------|:------------|:-------------------|:--------------|
| [data.geo.admin.ch Spatial Temporal Asset Catalog (STAC) – API](https://www.geo.admin.ch/en/rest-interface-stac-api) download service | swisstopo | [GeoAdmin Services Status Page](https://docs.geo.admin.ch/page/status-page.html) | MeteoSwiss [Open Data Support](https://www.meteoswiss.admin.ch/about-us/contact/contact-form.html) |
...
| Numerical weather forecasting model processing | [CSCS - Swiss National Supercomputing Centre](https://www.cscs.ch/services/contractual-partners) | [CSCS Status Page Central Services](https://status.cscs.ch/) <br></br> The ICON-CH1-EPS `2026-09-02 00:00 UTC` run is incomplete; forecast timesteps +20 h to +33 h are missing due to degraded S3 performance at CSCS. <br></br> Due to a CSCS S3 service interruption, NWP Open Data was incomplete: the ICON-CH1-EPS `2026-09-01 00:00 UTC` run is missing, the ICON-CH2-EPS `2026-09-01 00:00 UTC` run is incomplete, and KENDA-CH1 data is missing from `2026-08-31 23:00 UTC` through `2026-09-01 02:00 UTC` (with the `22:00 UTC` run incomplete). | MeteoSwiss [Open Data support](https://www.meteoswiss.admin.ch/about-us/contact/contact-form.html) |
