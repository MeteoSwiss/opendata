...
| Numerical weather forecasting model processing | [CSCS - Swiss National Supercomputing Centre](https://www.cscs.ch/services/contractual-partners) | [CSCS Status Page Central Services](https://status.cscs.ch/) <br></br> Due to an ongoing issue, recent NWP model runs have not been uploaded: KENDA data is missing from the `2026-09-16 20:00 UTC` run onward, ICON-CH1-EPS data from the `2026-09-16 21:00 UTC` run onward, and ICON-CH2-EPS data from the `2026-09-17 00:00 UTC` run onward. The cause is currently under investigation and the service has not yet been restored. | MeteoSwiss [Open Data support](https://www.meteoswiss.admin.ch/about-us/contact/contact-form.html) |
