...
| Numerical weather forecasting model processing | [CSCS - Swiss National Supercomputing Centre](https://www.cscs.ch/services/contractual-partners) | [CSCS Status Page Central Services](https://status.cscs.ch/) <br></br> `2026-03-04, 07:00-16:00 (UTC+1)`  HPC maintenance; model run data unavailable. <br></br> `2025-09-22, 21:00 - 2025-09-23, 03:00` Data of the respective model runs are unavailable | MeteoSwiss [Open Data support](https://www.meteoswiss.admin.ch/about-us/contact/contact-form.html) |
