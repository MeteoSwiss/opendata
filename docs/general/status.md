...
| Numerical weather forecasting model processing | [CSCS - Swiss National Supercomputing Centre](https://www.cscs.ch/services/contractual-partners) | [CSCS Status Page Central Services](https://status.cscs.ch/) <br></br> Due to a hardware failure, the uploads of the `2026-09-23 00:00 UTC` (ICON-CH1-EPS, ICON-CH2-EPS) and `2026-09-23 03:00 UTC` (ICON-CH1-EPS) NWP model runs are missing or incomplete. KENDA data is incomplete for the `2026-09-22 23:00 UTC` run. From the `2026-09-23 06:00 UTC` runs onward, the issue is expected to be resolved. | MeteoSwiss [Open Data support](https://www.meteoswiss.admin.ch/about-us/contact/contact-form.html) |
