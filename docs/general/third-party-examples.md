...
| [Open Data Archive browsing and visualization scripts](https://github.com/rigoge/Opendata) | Application | Application: [HTML scripts for browsing or visualizing gridded data archive and downloading multiple files at once](https://github.com/rigoge/Opendata) <img width="1862" height="986" alt="Swiss Radar Viewer Example" src="https://github.com/user-attachments/assets/d9975998-b410-4e2c-ab01-bf686db112b4" /> <img width="1881" height="991" alt="Swiss Gridded Surface Downloader Example" src="https://github.com/user-attachments/assets/19e8f4db-0f72-48cb-b5c8-2b2d3efb1655" />| This uses the [Surface Based Gridded Climate Datasets](https://opendatadocs.meteoswiss.ch/c-climate-data/c3-ground-based-climate-data) & [Radiation Based Gridded Climate Datasets ](https://opendatadocs.meteoswiss.ch/c-climate-data/c4-satellite-based-climate-data) & [Radar Based Gridded Climate Datasets](https://opendatadocs.meteoswiss.ch/c-climate-data/c5-radar-based-climate-data) & [Precipitation Radar Datasets](https://opendatadocs.meteoswiss.ch/d-radar-data/d1-precipitation-radar-products) & [Ground Based Measurements](https://opendatadocs.meteoswiss.ch/a-data-groundbased) | 05-2026 |
| [Weather OSINT](https://area51bbq.eu/storm/) | Application | Application: [https://area51bbq.eu/storm/](https://area51bbq.eu/storm/) | This uses the [Radar Data](https://opendatadocs.meteoswiss.ch/d-radar-data/d1-precipitation-radar-products). & [Local Forecast](https://opendatadocs.meteoswiss.ch/e-forecast-data/e4-local-forecast-data) & [Ground Based Data](https://opendatadocs.meteoswiss.ch/a-data-groundbased) | 08-2026 |
