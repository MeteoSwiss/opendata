...
| [Open Data Archive browsing and visualization scripts](https://github.com/rigoge/Opendata) | Application | Application: [HTML scripts for browsing or visualizing gridded data archive and downloading multiple files at once](https://github.com/rigoge/Opendata) | This uses the [Surface Based Gridded Climate Datasets](https://opendatadocs.meteoswiss.ch/c-climate-data/c3-ground-based-climate-data) & [Radiation Based Gridded Climate Datasets ](https://opendatadocs.meteoswiss.ch/c-climate-data/c4-satellite-based-climate-data) & [Radar Based Gridded Climate Datasets](https://opendatadocs.meteoswiss.ch/c-climate-data/c5-radar-based-climate-data) & [Precipitation Radar Datasets](https://opendatadocs.meteoswiss.ch/d-radar-data/d1-precipitation-radar-products) & [Ground Based Measurements](https://opendatadocs.meteoswiss.ch/a-data-groundbased) | 05-2026 |
