...
MeteoSwiss has identified two main challenges for the large-scale implementation of Open Data by analysing the needs of real users:
1. To enable people with varying levels of knowledge in data technology and meteorology to easily find the data they need, access to Open Data must be redesigned and simplified with the most relevant user groups in mind.
2. Application-oriented descriptions and contextual information must help users assess whether and under what conditions which data might be suitable for their application.

MeteoSwiss has identified two main challenges for its further implementation of Open Data by analysing the needs of real users:
...
## Vision and mission of MeteoSwiss' Open Data service
...
- the functionalities as well as
