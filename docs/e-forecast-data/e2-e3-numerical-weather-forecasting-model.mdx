...
Then, set `GRIB_DEFINITION_PATH` for ecCodes to use those tables (add it to your `.bashrc` to make it available in each terminal session):
...
<details>
<summary> <b> "How do I interpret the different types of vertical levels?" </b> </summary>
