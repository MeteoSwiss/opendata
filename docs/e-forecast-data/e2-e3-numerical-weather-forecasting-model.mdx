...
New data available at the end of April. Stay tuned so you don't miss it.

:::

We are pleased to announce that pollen and analysis (KENDA-CH1) data will become available by the end of April. This release introduces pollen data for the ICON-CH2-EPS control run and makes analysis data available for existing parameters, including the newly added pollen parameters.
