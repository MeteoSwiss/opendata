...
The data provided in the two collections described in the [Model specifications table](#model-specifications) is accessible for only **24 hours**. Data older than this is no longer available.
