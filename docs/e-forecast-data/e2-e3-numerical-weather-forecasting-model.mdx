...
- [Accessing the forecast data](#accessing-the-forecast-data)
...
<Tabs queryString="download-options">
    ...
    To obtain the ICON model data, we recommend using MeteoSwiss's [meteodata-lab](https://meteoswiss.github.io/meteodata-lab/) library - a convenient tool to simplify accessing and working with numerical weather model data.
    The library includes downloading ICON-CH1/2-EPS GRIB2 data and loading it into [xarray DataArray](https://docs.xarray.dev/en/stable/generated/xarray.DataArray.html).
...
The data provided in the two collections described in the [Model specifications table](#models-specifications) is accessible for only **24 hours**. Data older than this is no longer available.
Thus, your HTTP response returns empty.

</details>

<details>
<summary> <b> "Why do I get HTTPError: 403, when downloading with the Python API?" </b> </summary>
