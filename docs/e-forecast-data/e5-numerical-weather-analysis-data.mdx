...
To get started quickly, explore the [Jupyter notebook](https://github.com/MeteoSwiss/opendata-nwp-demos/blob/main/11_analysis_data.ipynb), which shows how to retrieve and visualize maximum wind gusts from analysis data.
...
| Step | 0 ([instant values](#instantaneous-analysis-fields)), 1 ([accumulated/max/min values](#first-guess-fields)) |
...
The list of available instantaneous variables can be identified in the **Overview of Parameters** file in the [collection](https://data.geo.admin.ch/browser/index.html#/collections/ch.meteoschweiz.ogd-analysis-kenda-ch1), where the *temporal aggregation* is labeled as "Instant".
...
The same pollen variables are also available in the [ICON-CH2-EPS forecast datasets](/e-forecast-data/e2-e3-numerical-weather-forecasting-model). The ICON-CH2-EPS control runs, initialized at **00, 06, 12 and 18 UTC**, provide pollen forecasts up to **+120 hours** ahead.

For a practical example, see the [Jupyter notebook](https://github.com/MeteoSwiss/opendata-nwp-demos/blob/main/10_icon_ch2_pollen_forecast.ipynb), which demonstrates how to retrieve, convert and visualize pollen data.
...
[Here](https://opendatadocs.meteoswiss.ch/e-forecast-data/e5-numerical-weather-analysis-data-changelog) you will find information about upcoming changes and the changelog.
