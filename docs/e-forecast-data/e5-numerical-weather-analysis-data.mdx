...
To get started quickly, explore the [Jupyter notebook](https://github.com/MeteoSwiss/opendata-nwp-demos/11_analysis_data.ipynb), which shows how to retrieve and visualize wind gusts from analysis data.
...
For a practical example, see the [Jupyter notebook](https://github.com/MeteoSwiss/opendata-nwp-demos/10_icon_ch2_pollen_forecast.ipynb), which demonstrates how to retrieve, convert and visualize pollen data.
