...
- 2026-05-21 - The forecast datasets will be extended to include pollen data, and analysis (KENDA-CH1) data will be available for the first time. See [News](https://opendatadocs.meteoswiss.ch/e-forecast-data/e2-e3-numerical-weather-forecasting-model#news).

## Stay in the loop!

If you want to be informed about changes, you can join the ICON-CH1-EPS, and ICON-CH2-EPS mailing lists.

Mails sent via these lists will also inform you about forecast delays, and cancellations.
